import {LZString as LZString} from "./lz-string.js";
console.log("abc");
/*! SugarCube JS */
...
if (true) {
    (function (window, document, jQuery, undefined) {
        ...
        var startWSRe,
          ...
          _trimString =
            ...
            function (str, where) {
              ...
              switch (where) {
                case "start":
                  return startWSRe.test(val)
                    ? val.replace(startWSRe, "")
                    : val;
                case "end":
        ...
        Array.prototype.flat ||
          Object.defineProperty(Array.prototype, "flat", {
            ...
            value: function flat() {
              ...
              var depth =
                0 === arguments.length ? 1 : Number(arguments[0]) || 0;
              return depth < 1
        ...
        (function () {
          ...
          Object.defineProperty(Array, "random", {
              ...
              value: function () {
                ...
                for (
                  var splice = Array.prototype.splice,
                    ...
                    delIndices = _toConsumableArray(cpyIndices).sort(
                      function (a, b) {
                        return b - a;
                      }
                    ),
                ...
                for (
                  var _i3 = 0, _iend = delIndices.length;
                  _i3 < _iend;
                  ++_i3
                )
            ...
            RegExp.escape ||
              ...
              (_hasRegExpMetaCharsRe = new RegExp(
                _regExpMetaCharsRe.source
              )),
              ...
              value: function (format) {
                ...
                return 0 === args.length
                  ...
                  ? ((_formatRegExp.lastIndex = 0),
                    format.replace(
                      _formatRegExp,
                      function (match, index, align) {
                        var retval = args[index];
                        if (null == retval) return "";
                        for (; "function" == typeof retval; )
                          retval = retval();
            ...
            Object.defineProperty(String.prototype, "toUpperFirst", {
              ...
              value: function () {
                ...
                return -1 === end
                  ? ""
                  : char.toUpperCase() + str.slice(end + 1);
              },
            }),
      ...
      var Browser =
          ...
          (isIE =
            !userAgent.includes("opera") && /msie|trident/.test(userAgent)),
          (ieVersion = isIE
        ...
        Has =
          ((hasAudioElement = (function () {
            try {
              return (
                "function" ==
                typeof document.createElement("audio").canPlayType
              );
            } catch (ex) {}
            return !1;
          })()),
            ...
            Object.defineProperties(
              {},
              {
                ...
                state: {
                  get: function () {
                    return (
                      (vendor && document[vendor.stateProperty]) ||
                      "visible"
                    );
                  },
                },
                ...
                isHidden: {
                  value: function () {
                    return Boolean(
                      vendor && document[vendor.hiddenProperty]
                    );
                  },
                },
                  ...
                  function (ev) {
                    jQuery(_this).off(namespace),
                      ev.type === vendor.errorEvent
                        ? reject(
                            new Error("unknown fullscreen request error")
                          )
                        : resolve();
                  }
                ),
          ...
          function exitFullscreen() {
            ...
            if (!vendor || "function" != typeof document[vendor.exitFn])
              return Promise.reject(
                new TypeError("fullscreen not supported")
              );
            if (!isFullscreen())
              return Promise.reject(
                new TypeError("fullscreen mode not active")
              );
                  ...
                  for (var i = 0, iend = ids.length; i < iend; ++i)
                    if (Story.has(ids[i]))
                      return (
                        new Wikifier(
                          el,
                          Story.get(ids[i]).processText().trim()
                        ),
                        el
                      );
                  if (null != defaultText) {
                  ...
                  switch (_typeof(value)) {
                    ...
                    case "object":
                      ...
                      if (value instanceof Map) {
                        var result = Array.from(value).map(function (
                          _ref4
                        ) {
          ...
          wiki: function () {
            for (
              var _len4 = arguments.length,
                sources = new Array(_len4),
                _key4 = 0;
              _key4 < _len4;
              _key4++
            )
              sources[_key4] = arguments[_key4];
            return this.wikiWithOptions.apply(
              this,
              [undefined].concat(sources)
            );
          },
        });
      var Util = (function () {
          ...
          var utilScrubEventKey = (function () {
              ...
              if (
                ...
                var match = new Intl.NumberFormat()
                  ...
                  .match(/(\D*)\d+(\D*)/);
                match &&
                  ((separatorKey = match[1]), (decimalKey = match[2]));
              }
              return (
                separatorKey ||
                  decimalKey ||
          ...
          return Object.freeze(
            Object.defineProperties(
              {},
              {
                    ...
                    if (code >= 55296 && code <= 56319) {
                      ...
                      return (
                        nextCode < 56320 ||
                          nextCode > 57343 ||
                          ((retval.char =
                            retval.char + str.charAt(nextPos)),
                          (retval.end = nextPos)),
                        retval
                      );
                    }
                ...
                toCssTime: {
                  value: function (msec) {
                    if (
                      ...
                      throw new Error(
                        "invalid milliseconds: ".concat(what)
                      );
                    }
                ...
                evalExpression: {
                  value: function () {
                    return Scripting.evalJavaScript.apply(
                      Scripting,
                      arguments
                    );
                  },
                      ...
                      },
                      {
                        ...
                        value: function (key) {
                          return (
                            !("string" != typeof key || !key) &&
                            null !==
                              _CookieAdapter._getCookie(this._prefix + key)
                          );
                        },
                      },
                      {
                    ...
                    [
                      {
                        ...
                        value: function (prefixedKey) {
                          ...
                          for (
                            ...
                            var kvPair = cookies[i].split("=");
                            if (
                              prefixedKey === decodeURIComponent(kvPair[0])
                            )
                    ...
                    if ("object" === _typeof(options))
                      return (
                        Object.keys(options).forEach(function (name) {
                          this[options[name] ? "addClass" : "removeClass"](
                            name
                          );
                        }, jQuery(this.view)),
                        this
              ...
              _createClass(NodeTyper, [
                ...
                },
                {
                  ...
                  value: function (flush) {
                    ...
                    if (this.appendTo) {
                      if (
                        ...
                        (this.node.nodeType !== Node.ELEMENT_NODE &&
                          ...
                          "none" ===
                            jQuery(this.node.parentNode).css("display"))
                      )
                        return this.finish();
                      this.node.parentNode &&
                        this.classNames &&
                        jQuery(this.node.parentNode).addClass(
                          this.classNames
                        );
                    }
                    if (this.nodeValue) {
                      if (flush)
                        ...
                        (this.node.nodeValue += char),
                          (this.nodeValue = this.nodeValue.slice(
                            1 + end - start
                          ));
                      }
                      return !0;
                    ...
                    this.classNames &&
                      (jQuery(this.node.parentNode).removeClass(
                        this.classNames
                      ),
        ...
        PRNGWrapper = (function () {
          function PRNGWrapper(seed, useEntropy) {
            _classCallCheck(this, PRNGWrapper),
              Object.defineProperties(
                this,
                new Math.seedrandom(seed, useEntropy, function (
                  prng,
                  seed
                ) {
                  return {
                  ...
                  value: function (rawCss) {
                    ...
                    _hasImageMarkupRe.test(css) &&
                      ...
                      (css = css.replace(
                        ...
                        function (wikiImage) {
                          var markup =
                            Wikifier.helpers.parseSquareBracketedMarkup({
                              source: wikiImage,
                              matchStart: 0,
                            });
                          if (
              ...
              {},
              {
                ...
                get: {
                  value: function (ids, overrides) {
                    ...
                    var selectedId,
                      id =
                        ((Array.isArray(ids) ? ids : [ids]).some(function (
                          id
                        ) {
                          return (
                      ...
                      (_patternRe.lastIndex = 0),
                        (processed = processed.replace(
                          ...
                          function (pat) {
                            ...
                            return overrides &&
                              overrides.hasOwnProperty(subId)
                              ? overrides[subId]
        ...
        SimpleAudio = (function () {
          var _hasPromise,
            ...
            AudioTrack = (function () {
              function AudioTrack(obj) {
                if (
                  (_classCallCheck(this, AudioTrack), obj instanceof Array)
                )
                  this._create(obj);
                else {
                ...
                _createClass(AudioTrack, [
                    ...
                    value: function () {
                      ...
                      if (
                        ...
                        this.sources.forEach(function (srcUri) {
                          var source = document.createElement("source");
                          (source.src = srcUri),
                            _this4.audio.appendChild(source);
                        });
                      }
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      if (this.isUnloaded())
                        return Promise.reject(
                          new Error("no sources are loaded")
                        );
                      if (this.isFailed())
                        return Promise.reject(
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      return (
                        jQuery.fn.on.apply(jQuery(this.audio), args), this
                      );
                    },
                  },
                  {
                    ...
                    value: function () {
                      ...
                      return (
                        jQuery.fn.one.apply(jQuery(this.audio), args), this
                      );
                    },
                  },
                  {
                    ...
                    value: function () {
                      ...
                      return (
                        jQuery.fn.off.apply(jQuery(this.audio), args), this
                      );
                    },
                  },
                ]),
          ...
          var AudioList = (function () {
              function AudioList(obj) {
                if (
                  (_classCallCheck(this, AudioList), obj instanceof Array)
                )
                  this._create(obj);
                else {
              ...
              return (
                _createClass(AudioList, [
                  ...
                  },
                  {
                    ...
                    value: function () {
                      return (null !== this.current &&
                        ...
                        : Promise.reject(
                            new Error("no tracks were available")
                          );
                    },
                  },
                  {
                  ...
                  },
                  {
                    ...
                    value: function (duration, toVol, fromVol) {
                      ...
                      if (
                        ...
                        var adjFromVol,
                          adjToVol =
                            Math.clamp(toVol, 0, 1) * this.current.volume;
                        return (
                          null != fromVol &&
                            (adjFromVol =
                              Math.clamp(fromVol, 0, 1) *
                              this.current.volume),
                          (this._volume = toVol),
                          this.current.track.fade(
                            duration,
                            adjToVol,
                            adjFromVol
                          )
                  ...
                  },
                  {
                    ...
                    value: function (_shuffle) {
                      ...
                      if (
                        ...
                        var _this$queue,
                          firstIdx = this.queue.findIndex(function (
                            trackObj
                          ) {
                        ...
                        if (-1 !== firstIdx)
                          (_this$queue = this.queue).push.apply(
                            _this$queue,
                            _toConsumableArray(
                              this.queue.splice(0, firstIdx + 1)
                            )
                          );
                      }
                      return this;
                  ...
                  },
                  {
                    ...
                    value: function () {
                      return (
                        0 === this.queue.length && null === this.current
                      );
                    },
                  },
                  {
                      ...
                      value: function () {
                        ...
                        return (
                          AudioRunner._run.apply(
                            AudioRunner,
                            [this.trackIds, AudioTrack.prototype.on].concat(
                              args
                            )
                          ),
                          this
              ...
              {},
              {
                      ...
                      {},
                      {
                        add: {
                          value: function () {
                            ...
                            _groups.set(
                              id,
                              Object.freeze(Array.from(group))
                            );
                          },
                        },
                        delete: {
                ...
                select: {
                  value: function () {
                    ...
                    try {
                      ...
                      _runnerParseSelector(selector).forEach(function (
                        idObj
                      ) {
                      ...
                      throw new Error(
                        "error during runner initialization: ".concat(
                          ex.message
                        )
                      );
                    }
                ...
                rate: {
                  value: function (rate) {
                    ...
                    publish(
                      "rate",
                      (_masterRate = Math.clamp(rate, 0.2, 5))
                    );
                  },
                },
                stop: {
                ...
                restore: {
                  value: function () {
                    if (session.has("state")) {
                      ...
                      return (
                        null != stateObj && (stateUnmarshal(stateObj), !0)
                      );
                    }
                    return !1;
                  },
                  ...
                  value: function (title) {
                    for (
                      0,
                        ...
                        _history.push(
                          momentCreate(title, _active.variables)
                        ),
        ...
        Scripting = (function () {
          function addAccessibleClickHandler(
            ...
            if (
              ("function" == typeof selector
                ? ((fn = selector),
                  (opts = { namespace: one, one: !!handler }))
                : ((fn = handler),
                  (opts = {
                    namespace: namespace,
                    one: !!one,
          ...
          function lastVisited() {
            ...
            for (
              ...
              turns = Math.min(
                turns,
                -1 === lastIndex ? -1 : uBound - lastIndex
              );
            }
            return turns;
          }
          ...
          function time() {
            return null === Engine.lastPlay
              ? 0
              : Util.now() - Engine.lastPlay;
          }
          function turns() {
            return State.turns;
          }
            ...
            parse = (function () {
              ...
              function parseTemplate(rawTemplateLiteral) {
                ...
                for (
                  ...
                  null !==
                  (startMatch = templateGroupStartRe.exec(template));
                  ...
                  for (
                    ...
                    null !==
                    (endMatch = templateGroupParseRe.exec(template));
                ...
                [
                  ...
                  },
                  {
                    ...
                    value: function () {
                      for (
                        ;
                        0 === this.items.length && null !== this.state;
                  ...
                  },
                  {
                    ...
                    value: function (valid) {
                      ...
                      return (
                        -1 !== ch &&
                        (!!valid.includes(ch) || (this.backup(), !1))
                      );
                    },
                  },
                  {
            ...
            Object.defineProperties(Wikifier.helpers, {
                      ...
                      if (
                        ...
                        if (match[1])
                          ...
                          for (
                            ...
                            null !==
                            (subMatch = idOrClassRe.exec(match[5]));
              ...
              evalText: {
                value: function (text) {
                  ...
                  try {
                    switch (
                      _typeof((result = Scripting.evalTwineScript(text)))
                    ) {
                      case "string":
              ...
              createShadowSetterCallback: {
                value: (function () {
                  ...
                  return function (code) {
                    var shadowStore = {};
                    return (
                      getMacroContextShadowView().forEach(function (
                        varName
                      ) {
        ...
        Wikifier.Parser.add({
          ...
          handler: function (w) {
            Wikifier.helpers.hasBlockContext(w.output.childNodes)
              ...
              : jQuery(w.output).append(
                  document.createTextNode(w.matchText)
                );
          },
        }),
          Wikifier.Parser.add({
          ...
          Wikifier.Parser.add({
              ...
              if (this.parseTag(w)) {
                ...
                try {
                  ...
                  var args = payload
                    ...
                    : this.createArgs(
                        rawArgs,
                        this.skipArgs(macro, macro.name)
                      );
            ...
            parseBody: function (w, macro) {
              for (
                ...
                -1 !==
                (w.matchStart = w.source.indexOf(this.match, w.nextMatch));
          ...
          Wikifier.Parser.add({
            ...
            handler: function (w) {
              switch (w.matchText) {
                ...
                case "==":
                  w.subWikify(
                    jQuery(document.createElement("s"))
                      .appendTo(w.output)
                      .get(0),
                    "=="
                  );
          ...
          Wikifier.Parser.add({
            ...
            handler: function (w) {
              ...
              null == result
                ? jQuery(document.createTextNode(w.matchText)).appendTo(
                    w.output
                  )
                : new Wikifier(
                    (Config.debug
          ...
          Wikifier.Parser.add({
            ...
            handler: function (w) {
              Wikifier.helpers.hasBlockContext(w.output.childNodes)
                ? w.subWikify(
                    jQuery(
                      document.createElement("h".concat(w.matchLength))
                    )
                      .appendTo(w.output)
                      .get(0),
                    this.terminator
                ...
                if (
                  ...
                  if ("~" === cellMatch[1]) {
                    ...
                    last &&
                      ...
                      (w.nextMatch =
                        cellMatch.index + cellMatch[0].length - 1);
                  } else if (">" === cellMatch[1])
                    ++curColCount,
                      (w.nextMatch =
                        cellMatch.index + cellMatch[0].length - 1);
          ...
          Wikifier.Parser.add({
            ...
            handler: function (w) {
              ...
              for (
                var match, depth = 1;
                depth > 0 &&
                null !== (match = this.lookahead.exec(w.source));
              ...
              if (0 === depth) {
                ...
                var svgTag = w.source.slice(
                  ...
                  $frag = jQuery(document.createDocumentFragment()).append(
                    svgTag
                  );
                $frag
          ...
          Wikifier.Parser.add({
            ...
            handler: function (w) {
              ...
              if (tagName) {
                ...
                output.appendChild(
                  "track" === tagName ? el.cloneNode(!0) : el
                );
              }
            },
            processAttributeDirectives: function (el) {
              ...
              {},
              {
                add: {
                  value: function (name, template) {
                    ...
                    (name instanceof Array ? name : [name]).forEach(
                      function (name) {
                        ...
                        if (_templates.has(name))
                          throw new Error(
                            "cannot clobber existing template ?".concat(
                              name
                            )
                          );
                ...
                add: {
                  value: function macrosAdd(name, def) {
                    if (Array.isArray(name))
                      ...
                      if (!_validNameRe.test(name))
                        throw new Error(
                          'invalid macro name "'.concat(name, '"')
                        );
                      if (macrosHas(name))
                        throw new Error(
                          "cannot clobber existing macro <<".concat(
                            name,
                            ">>"
                          )
                        );
        ...
        if (
                    ...
                    var typeNode = function () {
                      var typeNodeMember = function (typeIntervalId) {
                        (State.passage === passage &&
                          ...
                          TempState.macroTypeQueue &&
                            TempState.macroTypeQueue.length > 0 &&
                            TempState.macroTypeQueue.first().id ===
                              selfId &&
                            TempState.macroTypeQueue.shift(),
          ...
          Macro.add("switch", {
            ...
            handler: function () {
              ...
              for (
                Config.debug &&
                  debugView.modes({ nonvoid: !1, hidden: !0 }),
                  i = 1;
                i < len;
                ++i
              ) {
          ...
          Macro.add("for", {
            ...
            handleForRange: function (
              ...
              try {
                ...
                for (var i = 0; i < rangeList.length; ++i)
                  if (
                    (indexVar.name &&
                      (State[indexVar.type][indexVar.name] =
                        rangeList[i][0]),
            ...
            toRangeList: function (rangeExp) {
              ...
              try {
                ...
                throw (
                  ((ex.message = "bad range expression: ".concat(
                    ex.message
                  )),
                  ex)
                );
            ...
            handler: function () {
              ...
              if ("object" === _typeof(this.args[0]))
                ...
                $link.wikiWithOptions({ profile: "core" }, this.args[0]),
                  (passage =
                    this.args.length > 1 ? this.args[1] : undefined);
              null != passage
                ? ($link.attr("data-passage", passage),
                  Story.has(passage)
                    ? ($link.addClass("link-internal"),
                  ...
                  $select
                    ...
                    .on(
                      ...
                      this.createShadowWrapper(function () {
                        State.setVar(
                          varName,
                          options[Number(this.value)].value
                        );
                      })
                    )
                    .appendTo(this.output);
            ...
            handler: function () {
              ...
              this.args.length > 3
                ...
                autofocus &&
                  ...
                  (postdisplay["#autofocus:".concat(el.id)] = function (
                    task
                  ) {
          ...
          Macro.add(["addclass", "toggleclass"], {
            handler: function () {
              ...
              if (0 === $targets.length)
                return this.error(
                  'no elements matched the selector "'.concat(
                    this.args[0],
                    '"'
                  )
                );
          ...
          Macro.add("audio", {
            handler: function () {
              ...
              for (
                ...
                switch (arg) {
                  ...
                  case "unload":
                    if (action)
                      return this.error(
                        errorOnePlaybackAction(arg, action)
                      );
                    action = arg;
                    break;
                  case "fadein":
                  ...
                  case "fadeto":
                    ...
                    if (
                      ...
                      return this.error(
                        "cannot parse fadeto: ".concat(raw)
                      );
                    break;
                  case "fadeoverto":
                    if (action)
                    ...
                    if (
                      ...
                      return this.error(
                        "cannot parse fadeoverto: ".concat(raw)
                      );
                    if (
                      ((raw = args.shift()),
                      (fadeTo = Number.parseFloat(raw)),
                  ...
                  case "volume":
                    ...
                    if (
                      ...
                      return this.error(
                        "cannot parse volume: ".concat(raw)
                      );
                    break;
                  case "mute":
                  case "unmute":
                  ...
                  case "goto":
                    ...
                    if (
                      ((raw = args.shift()),
                      (passage =
                        "object" === _typeof(raw) ? raw.link : raw),
                      !Story.has(passage))
                    )
                      return this.error(
                        'passage "'.concat(passage, '" does not exist')
              ...
              try {
                if (
                  ...
                  var nsEnded = "ended.macros.macro-".concat(
                    this.name,
                    "_goto"
                  );
                ...
                return this.error(
                  "error executing action: ".concat(ex.message)
                );
              }
            },
          }),
            ...
            Macro.add("createaudiogroup", {
              ...
              handler: function () {
                ...
                Config.debug &&
                  this.debugView.modes({ nonvoid: !1, hidden: !0 });
                for (
              ...
              handler: function () {
                ...
                if ("createplaylist" === from) {
                  ...
                  if (!SimpleAudio.lists.has(id))
                    return this.error(
                      'playlist "'.concat(id, '" does not exist')
                    );
            ...
            Macro.add("removeaudiogroup", {
              handler: function () {
                ...
                if (!SimpleAudio.groups.has(id))
                  return this.error(
                    'group "'.concat(id, '" does not exist')
                  );
          ...
          Macro.add("widget", {
            ...
            handler: function () {
              ...
              var widgetCode,
                ...
                isNonVoid =
                  this.args.length > 1 && "container" === this.args[1];
                  ...
                  handler:
                    ...
                    function () {
                      ...
                      State.temporary.hasOwnProperty("args") &&
                        ...
                        (State.temporary.args = _toConsumableArray(
                          this.args
                        )),
                        ...
                        isNonVoid &&
                          (State.temporary.hasOwnProperty("contents") &&
                            (shadowStore._contents =
                              State.temporary.contents),
                          (State.temporary.contents =
                            this.payload[0].contents),
                      ...
                      try {
                        ...
                        if (
                          ...
                          Array.from(
                            resFrag.querySelectorAll(".error")
      ...
      var Dialog = (function () {
          ...
          function dialogOpen(options, closeFn) {
            ...
            return (
              ...
              Has.mutationObserver
                ? (_dialogObserver = new MutationObserver(function (
                    mutations
                  ) {
          ...
          function _calcPosition(topPos) {
            ...
            return (
              horzSpace <= 32 + _scrollbarWidth &&
                (vertSpace -= _scrollbarWidth),
              vertSpace <= 32 + _scrollbarWidth &&
          ...
          function _resizeHandler(ev) {
            var top =
              ev && ev.data && void 0 !== ev.data.top ? ev.data.top : 50;
            "block" === _$dialog.css("display") &&
              (_$dialog.css({ display: "none" }),
              _$dialog.css(
                jQuery.extend({ display: "" }, _calcPosition(top))
              ));
          }
          return Object.freeze(
            Object.defineProperties(
                ...
                init: {
                  value: function () {
                    if (!document.getElementById("ui-dialog")) {
                      ...
                      (_$overlay = jQuery(
                        $elems.find("#ui-overlay").get(0)
                      )),
                        (_$dialog = jQuery(
                          $elems.find("#ui-dialog").get(0)
                        )),
        ...
        Engine = (function () {
          ...
          function enginePlay(title, noHistory) {
            ...
            if (
              ...
              try {
                var overrideTitle =
                  Config.navigation.override(passageTitle);
            ...
            jQuery(passageEl)
              ...
              Story.has("PassageHeader") &&
                new Wikifier(
                  passageEl,
                  Story.get("PassageHeader").processText()
                ),
              passageEl.appendChild(passage.render()),
              Story.has("PassageFooter") &&
                new Wikifier(
                  passageEl,
                  Story.get("PassageFooter").processText()
                ),
              jQuery.event.trigger({
                type: ":passagerender",
                content: passageEl,
            ...
            if (
              (containerEl.hasChildNodes() &&
                ...
                ("string" == typeof Config.passages.transitionOut &&
                  ...
                  ? _toConsumableArray(containerEl.childNodes).forEach(
                      function (outgoing) {
                    ...
                    value: function () {
                      ...
                      return (
                        Config.passages.onProcess &&
                          (processed = Config.passages.onProcess.call(
                            null,
                            {
                              title: this.title,
                              tags: this.tags,
        ...
        Save = (function () {
          ...
          function autosaveOk() {
            return (
              "cookie" !== storage.name && void 0 !== Config.saves.autosave
            );
          }
          function slotsOk() {
          ...
          function _unmarshal(saveObj) {
            try {
              ...
              if (
                ((saveObj.state.history = State.deltaDecode(
                  saveObj.state.delta
                )),
                        ...
                        (Config.saves.slots < saves.slots.length
                          ? (saves.slots.reverse(),
                            (saves.slots = saves.slots.filter(
                              ...
                              {
                                count:
                                  saves.slots.length - Config.saves.slots,
                              }
                            )),
                            saves.slots.reverse())
                          : Config.saves.slots > saves.slots.length &&
                      ...
                      {},
                      {
                          ...
                          value: function (title, metadata) {
                            ...
                            var saves = savesObjGet(),
                              supplemental = {
                                title:
                                  title ||
                                  Story.get(State.passage).description(),
                                date: Date.now(),
                              };
                            return (
                              null != metadata &&
                        ...
                        delete: {
                          value: function () {
                            var saves = savesObjGet();
                            return (
                              (saves.autosave = null), _savesObjSave(saves)
                            );
                          },
                        },
                      }
            ...
            switch (type) {
              ...
              case Types.Range:
                ...
                var stepValidate = function (value) {
                    if (fracDigits > 0) {
                      var ma = Number(
                          "".concat(def.min, "e").concat(fracDigits)
                        ),
                        sa = Number(
                          "".concat(def.step, "e").concat(fracDigits)
                        ),
                        _va =
                          Number("".concat(value, "e").concat(fracDigits)) -
                          ma;
                      return Number(
                        ""
                          .concat(_va - (_va % sa) + ma, "e-")
                          .concat(fracDigits)
                      );
                    }
            ...
            Object.defineProperties(
              {},
              {
                ...
                reset: {
                  value: function (name) {
                    if (0 === arguments.length)
                      settingsClear(), settingsLoad();
                    else {
                      if (null == name || !definitionsHas(name))
                        throw new Error(
                          'nonexistent setting "'.concat(name, '"')
                        );
                ...
                addToggle: {
                  value: function () {
                    ...
                    definitionsAdd.apply(
                      void 0,
                      [Types.Toggle].concat(args)
                    );
                  },
                },
                addList: {
                ...
                load: {
                  value: function () {
                    ...
                    function validateSpecialPassages(passage) {
                      if (
                        validationNoCodeTagPassages.includes(passage.title)
                      ) {
                        for (
        ...
        UI = (function () {
          ...
          function uiBuildAutoload() {
            return (
              jQuery(
                Dialog.setup(L10n.get("autoloadTitle"), "autoload")
              ).append(
                "<p>".concat(
          ...
          function uiBuildJumpto() {
            ...
            jQuery(
              Dialog.setup(L10n.get("jumptoTitle"), "jumpto list")
            ).append(list);
            for (
              ...
              (savesOk &&
                $dialogBody.append(
                  (function () {
                    ...
                    for (
                      var i = 0, iend = saves.slots.length;
                      i < iend;
                      ++i
                    ) {
              ...
              Setting.forEach(function (control) {
                ...
                switch (
                  ...
                  case Setting.Types.List:
                    ...
                    for (
                      var i = 0, iend = control.list.length;
                      i < iend;
                      ++i
                    )
                      jQuery(document.createElement("option"))
          ...
          function uiBuildShare() {
            try {
              jQuery(
                Dialog.setup(L10n.get("shareTitle"), "share list")
              ).append(uiAssembleLinkList("StoryShare"));
            } catch (ex) {
              return (
                console.error(ex), Alert.error("StoryShare", ex.message), !1
              );
            }
            return !0;
          }
                  ...
                  value: function () {
                    _$uiBar &&
                      (("boolean" == typeof Config.ui.stowBarInitially
                        ...
                        : jQuery(window).width() <=
                          Config.ui.stowBarInitially) && uiBarStow(!0),
        ...
        DebugBar = (function () {
          ...
          function debugBarStow() {
            _$debugBar.css(
              "right",
              "-".concat(_$debugBar.outerWidth(), "px")
            ),
              (_stowed = !0),
              _updateSession();
          }
          ...
          function _updateWatchBody() {
            if (0 !== _watchList.length) {
              ...
              _$watchBody
                .empty()
                .append(
                  "<div>".concat(L10n.get("debugBarNoWatches"), "</div>")
                );
          }
          ...
          function _toWatchString(value) {
            ...
            if (value instanceof Array || value instanceof Set) {
              for (
                var list =
                    value instanceof Array ? value : Array.from(value),
                  i = 0,
                  len = list.length;
                i < len;
                ++i
